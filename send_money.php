...
<body style="background-color:#1414f4; padding-top:8%;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            ...
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="send_money.php" method="post">
                    ...
                    <p style="color:white;">Want to check your balance? check <a style="color: rgb(255, 8, 8);" href="check_blc.php">here</a></p>
                </form>
            </div>
        </div>
        ...
        if($_SERVER['REQUEST_METHOD']== 'POST'){
            ...
            $checkblcquery = "SELECT blc FROM bankdetails where accno='$sender'";
            $checkblc = mysqli_query($conn, $checkblcquery);
            $ava_blc = mysqli_fetch_assoc($checkblc)['blc'];

            if($ava_blc >= $amount){
            $sql1 = "UPDATE bankdetails SET blc= blc-$amount WHERE accno='$sender'";
            $sql2 = "UPDATE bankdetails SET blc= blc+$amount WHERE accno='$reciever'";
